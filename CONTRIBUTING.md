...
If unique, [open an issue](https://github.com/gopad/gopad-android/issues) and answer the questions so we can understand and reproduce the problematic behavior.
